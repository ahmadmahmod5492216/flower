...
class ServerMessage(google.protobuf.message.Message):
    ...
    class ExampleIns(google.protobuf.message.Message):
        ...
        def __init__(self,
            *,
            question: typing.Text = ...,
            l: typing.Optional[typing.Iterable[builtins.int]] = ...,
            ) -> None: ...
    ...
    def __init__(self,
        *,
        ...
        example_ins: typing.Optional[global___ServerMessage.ExampleIns] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["evaluate_ins",b"evaluate_ins","example_ins",b"example_ins","fit_ins",b"fit_ins","get_parameters_ins",b"get_parameters_ins","get_properties_ins",b"get_properties_ins","msg",b"msg","reconnect_ins",b"reconnect_ins"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["evaluate_ins",b"evaluate_ins","example_ins",b"example_ins","fit_ins",b"fit_ins","get_parameters_ins",b"get_parameters_ins","get_properties_ins",b"get_properties_ins","msg",b"msg","reconnect_ins",b"reconnect_ins"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["msg",b"msg"]) -> typing.Optional[typing_extensions.Literal["reconnect_ins","get_properties_ins","get_parameters_ins","fit_ins","evaluate_ins","example_ins"]]: ...
...
class ClientMessage(google.protobuf.message.Message):
    ...
    EXAMPLES_RES_FIELD_NUMBER: builtins.int
    @property
    ...
    @property
    def examples_res(self) -> global___ClientMessage.ExampleRes: ...
    def __init__(self,
        *,
        ...
        examples_res: typing.Optional[global___ClientMessage.ExampleRes] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["disconnect_res",b"disconnect_res","evaluate_res",b"evaluate_res","examples_res",b"examples_res","fit_res",b"fit_res","get_parameters_res",b"get_parameters_res","get_properties_res",b"get_properties_res","msg",b"msg"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["disconnect_res",b"disconnect_res","evaluate_res",b"evaluate_res","examples_res",b"examples_res","fit_res",b"fit_res","get_parameters_res",b"get_parameters_res","get_properties_res",b"get_properties_res","msg",b"msg"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["msg",b"msg"]) -> typing.Optional[typing_extensions.Literal["disconnect_res","get_properties_res","get_parameters_res","fit_res","evaluate_res","examples_res"]]: ...
