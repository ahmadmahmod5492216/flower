...
class SimpleClientManager(ClientManager):
    ...
    def threshold(self) -> float:
        ...
        # Clloect the IEs of all clients
        ...
        states = {'symmetric': (mean - std), 'positive_assymmetry': q1, 'negative_assymmetry': (q1 - 1.5*(q3-q1))}
        if symmetry_index > 0.35:
            return states['positive_assymmetry']
        elif symmetry_index < -1.2:
            return states['negative_assymmetry']
        else:
